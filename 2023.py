...
from utils import (
    set_dataset_aigc_2023, _preprocess2, _preprocess3,
...
# ---------------- Hyper‑parameters -----------------
# ---------------------------------------------------
checkpoint_dir = "2023_mos1/session1"
...
def main():
    ...
    root = "./Database/AIGCIQA2023"; session = now_session
    train_loader = set_dataset_aigc_2023(os.path.join(root, str(session), "train.csv"), bs,
                                    "/home/data/wpy/IPCE-main/data/AIGCIQA2023/file",
                                    num_workers, preprocess3, train_patch-1, False)
    val_loader   = set_dataset_aigc_2023(os.path.join(root, str(session), "val.csv"), bs,
                                    "/home/data/wpy/IPCE-main/data/AIGCIQA2023/file",
    ...
    for epoch in range(num_epoch):
        ...
        if epoch== num_epoch - 1:
            torch.save({"model_state_dict": model.state_dict()},
                       os.path.join(checkpoint_dir, "last_ckpt.pt"))
            log_and_print(log, "[Last] model saved.")
